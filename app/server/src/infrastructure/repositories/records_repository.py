...
class RecordRepository:
    ...
    def get_record(self, federation_slug: str, equipment: str, weight: str, age: str, sex: str = "M") -> Optional[Record]:
    ...
    def get_federation_records(self, federation_slug: str, equipment: str) -> List[Record]:
